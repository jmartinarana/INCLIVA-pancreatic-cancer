...
#SBATCH --ntasks 1
#SBATCH --nodes 1
#SBATCH --job-name contra_3
#SBATCH --partition long
#SBATCH --cpus-per-task 10# “-c”
#SBATCH --mem 4G
#SBATCH --output=contra_3_%j.out
#SBATCH --array=0-30
...
/home/mibarrola/info/software/packages/in_house_scripts_/CNVs/exome/plasmas/run_contra_plasma_parte3_v2.0.sh \
