...
#SBATCH --ntasks 1
#SBATCH --nodes 1
#SBATCH --job-name wisecondor3
#SBATCH --partition long
#SBATCH --cpus-per-task 1# “-c”
#SBATCH --mem 4G
#SBATCH --output=wisecondor3_%j.out
#SBATCH --array=0-30
...
/home/mibarrola/info/software/packages/in_house_scripts_/CNVs/exome/plasmas/run_wisecondor_ONE_parte3.sh \
