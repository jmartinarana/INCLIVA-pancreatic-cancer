...
unset display
echo "$sing $cnvkit batch $bam_dir_FFPE/*.bam --normal $bam_dir_WBC/*.bam --targets $panel/target.bed --fasta $genome --output-reference cnvkit_output --output-dir $output_dir"
...
sbatch /clinicfs/userhomes/mibarrola/UMP444_exomas_pancreas_1108/scripts/cnvs_ffpe/min_coverage/inc_sbatch_cnv_ffpe.sh
