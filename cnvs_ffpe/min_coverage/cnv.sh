...
echo "COMMAND --- run_facets_v2.1.sh -f $conf -t $tumor -n $normal"
/home/mibarrola/info/software/packages/in_house_scripts_/CNVs/exome/run_facets_v2.0.sh -f  $conf -t $tumor -n $normal
echo "fin run_facets"
chmod -R 776 $output_dir
echo "COMMAND ---varscan2_pipeline_ONE_v2.1.sh -f  $conf -t $tumor -n $normal"
/home/mibarrola/info/software/packages/in_house_scripts_/CNVs/exome/varscan2_pipeline_ONE_v2.1.sh -f $conf -t $tumor -n $normal
...
chmod -R 776 $output_dir
echo "COMMAND --- /home/mibarrola/info/software/packages/in_house_scripts_/CNVs/exome/merge/merge_results_genes_v2.2.sh -f  $conf -t $tumor"
